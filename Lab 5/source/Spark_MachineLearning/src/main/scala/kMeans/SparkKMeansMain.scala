...
object SparkKMeansMain {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val (corpusVector, data, vocabSize) = preprocess1(sc, inputPath)
  ...
  /**
    ...
    */
  private def preprocess2(sc: SparkContext,paths: Seq[String]): (RDD[(Long, Vector)], RDD[(String,String)], Long) = {
  ...
  /**
    ...
    * @return (corpus, vocabulary as array, total token count in corpus)
    */
  private def preprocess1(sc: SparkContext,paths: Seq[String]): (RDD[(Long, Vector)], RDD[(String,String)], Long) = {
